...
export default function Register() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950 flex overflow-hidden transition-colors duration-300">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-gray-50/50 dark:bg-slate-950 overflow-y-auto transition-colors">
        <motion.div 
        ...
        >
          <div className="bg-white dark:bg-slate-900 p-10 rounded-[40px] shadow-2xl shadow-emerald-900/5 dark:shadow-black/30 border border-gray-100 dark:border-slate-800 transition-colors">
            <div className="mb-10">
              ...
              <h2 className="text-3xl font-black text-gray-900 dark:text-white mb-2 tracking-tight">Buat Akun</h2>
              <p className="text-gray-500 dark:text-gray-400 font-medium">Lengkapi data di bawah untuk mendaftar.</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                <label className="block text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-[0.2em] mb-2 ml-1">Nama Lengkap</label>
              ...
              <div>
                <label className="block text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-[0.2em] mb-2 ml-1">Password</label>
                <div className="relative group">
            ...
            <div className="mt-10 pt-10 border-t border-gray-50 dark:border-slate-800 text-center">
              <p className="text-sm text-gray-500 dark:text-gray-400 font-medium">
                Sudah punya akun? {' '}
                <Link href="/login" className="text-emerald-600 dark:text-emerald-400 font-black hover:underline">Login di sini</Link>
              </p>
            </div>
          </div>
